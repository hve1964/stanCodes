...
This R Markdown `html_notebook` provides worked examples in statistical
...
\qquad
\sigma^{2}
:= \mathrm{Var}\left(\left.y_{n}\right| I\right)
= \text{constant}
\]
\[
...
\alpha_{0} \sim \mathrm{Exp}(1/(1~\mathrm{kg})^{2}) \ , \qquad
