...
`lubridate` by Grolemund and Wickham (2011) and `scales` by Wickham H and D 
Seidel (2022).
...
19. H Wickham H and D Seidel (2022) scales: Scale functions for visualization (R package version 1.2.0) URL (cited on August 27, 2022): https://CRAN.R-project.org/package=scales
